...
section_description: This report examines the LPG shortage in India triggered by the US-Iran War, blending real-world case studies, essential context, and practitioner-focused strategies to address the crisis, with a focus on India's perspective and policy responses.
section_type: root
node_level: 0 / max_depth: 2
section_heading: ## Comprehensive Study of LPG Shortage in India Amid US-Iran War  (assembler adds this — do NOT include it in your content; use deeper levels for internal sub-headings)
...
```
{
  ...
  "citations_found": ["[WeconsiderEveryMilewed]", "[IndialowersFuelTaxes]", "[IndianewsGovernmentCut]"],
  "key_evidence_chunks": []
}
```
