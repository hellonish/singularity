...
section_description: Provides concrete worked examples and experiments demonstrating incorrect inductive biases across domains like vision and language, using datasets and video resources.
section_type: chapter
node_level: 1 / max_depth: 2
section_heading: ### Illustrative Examples of Incorrect Biases  (assembler adds this — do NOT include it in your content; use deeper levels for internal sub-headings)
...
[Evidence 0 | Cite as: [UtilizingAdversarialEx]] Source: Utilizing Adversarial Examples for Bias Mitigation and Accuracy Enhancement (https://doi.org/10.48550/arXiv.2404.11819) | credibility=0.90
...
[Evidence 2 | Cite as: [ContextInductiveBiases]] Source: The in-context inductive biases of vision-language models differ across ... (https://arxiv.org/html/2502.01530v2) | credibility=0.90
For example, Chan et al. (2022) show that models have differentinductivebiasesfor generalizing from information learned in context or in weights. Thus, modern vision-languagemodels (VLMs) present an interesting dimension to few-shot learning that has not been thoroughly explored—the effect of the pr
...
[Evidence 4 | Cite as: [ShortcutLearningLarge]] Source: Shortcut Learning of Large Language Models in Natural Language Understanding | Communications of the ACM (https://dl.acm.org/doi/abs/10.1145/3596490) | credibility=0.75
...
[Evidence 6 | Cite as: [ContextInductiveBiases2]] Source: The in-context inductive biases of vision-language models differ across ... (https://arxiv.org/html/2502.01530v1) | credibility=0.90
...
[Evidence 7 | Cite as: [LearningEnrichedInduct]] Source: Learning with Enriched Inductive Biases for Vision-Language Models (https://link.springer.com/article/10.1007/s11263-025-02354-1) | credibility=0.90
Vision-LanguageModels, pre-trained on large-scale image-text pairs, serve as strong foundation models for transfer learning across a variety of downstream tasks. For few-shot generalization tasks, i.e., when the model is trained on few-shot samples and then tested on unseen categories or datasets, t

[Evidence 8 | Cite as: [TowardsHighlyTransfera]] Source: Towards Highly TransferableVision-LanguageAttack via... (https://arxiv.org/html/2603.04839v3) | credibility=0.90
Vision-languageattacks typically induce a semantic mismatch between the adversarial image and its corresponding adversarial text, while adhering to predefined perturbation constraints in both the visual and textualdomains.
...
```
{
  ...
  "citations_found": ["[ContextInductiveBiases]", "[UtilizingAdversarialEx]", "[ShortcutLearningLarge]", "[InductiveBiasesDeep]", "[TailoringEncodingInduc]", "[LearningInductiveBiase]"],
  "key_evidence_chunks": []
}
```
