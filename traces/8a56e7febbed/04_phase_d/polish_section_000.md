...
Give a couple of different incorrect inductive biases in deep learning and illustrate them with experiments.

- You can explore different domains (vision, language, etc).
- Focus on learning biases only.
- How can we address these biases?
- Provide a couple of different solutions from the literature and suggest your own method.
```
